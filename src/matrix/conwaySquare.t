...
// conwaySquare.t
//
//	Generate magic squares using Conway's LUX method.  Handles squares
//	with orders of the form 4n + 2:  6, 10, 14, and so on.
//
//
#include <adv3.h>
#include <en_us.h>
...
class ConwaySquare: MagicSquare
	generateEven() {
		local v;

		// Make sure we have an order of the form 4n + 2.
		v = (size[1] - 2) / 4;
		if(((4 * v) + 2) != size[1])
			return;
