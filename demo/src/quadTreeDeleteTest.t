#charset "us-ascii"
//
// quadTreeDeleteTest.t
// Version 1.0
// Copyright 2022 Diegesis & Mimesis
//
// Test of the quadtree node deletion logic.
//
// It can be compiled via the included makefile with
//
//	# t3make -f quadTreeDeleteTest.t3m
//
...
gameMain: GameMainDef
	...
	createTree() {
		...
		// Create the tree.
		_tree = new QuadTree(0, 0, nodes, nodes);
	...
	restoreTest() {
		...
		// quadTreeTest.t, because all the deleted records should
		// now be restored.
		for(i = 0; i < nodes; i++) {
			ar = _tree.query(i, i);
